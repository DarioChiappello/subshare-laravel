    ...
    <body id="page-top">
        ...
        <div class=" masthead container d-flex align-items-center flex-column">
                ...
                <div class="header text-white text-center">
                    <!-- Masthead Heading-->
                    <h1 class="masthead-heading" style="font-weight: bold;font-size: 64px;font-family: Montserrat;color: #FFFFFF;line-height: 78px;">Bringing Freedom to music artists</h1>
                    <span class="v349_26"style="font-family: Montserrat;
                    font-style: normal;
                    font-weight: normal;
                    font-size: 24px;
                    line-height: 36px;">We
                        believe in <b> Freedom, Fair Ownership </b>, and the power of <b> Unity & Music</b>.
        ...
        <div class="row">
            ...
            <img id="img-screen" class="img-fluid" src="{{url('/assets/img/portfolio/screen.png')}}"  style="width: 100%;"  alt="" />
            </div>
            {{--padding-bottom:6%;--}}
            <div class="col-md-6" style="padding-top:2%;" >
                    {{--<img class="img-fluid" src="{{url('/assets/img/portfolio/about-text.png')}}"  style="width: 100%;"  alt="" />--}}
                    <h2 id="t1" style="margin-top:6%;margin-left:8%;//styleName: Heading 1;
                        font-family: Montserrat;
                        font-size: 40px;
                        font-style: normal;
                        font-weight: 700;
                    ...
                    <div class="row" style="margin-top:4%;margin-left:8%;">
                        <div class="col-md-2">
                        <img class="img-fluid" src="{{url('/assets/img/portfolio/v1.png')}}" id="icon"  style="width: 100%;"  alt="" />
                        </div>
                        <div class="col-md-10">
                            <h3 style="color:#2C4064;">Power</h3>
                            <p style="color: #69768D;">• Complete creative control.</p>
                            <p style="color: #69768D;">• Access to people with key skills.</p>
                            <p style="color: #69768D;">• Collaborate with others.</p>
                            <p style="color: #69768D;">• Get the exposure and resources you need to succeed.</p>
                            <p style="color: #69768D;">• Complete your music.</p>
                        </div>
                    </div>
                    <div class="row" style="margin-top:3%;margin-left:8%;">
                        <div class="col-md-2">
                        <img class="img-fluid" src="{{url('/assets/img/portfolio/v2.png')}}" id="icon"  style="width: 100%;"  alt="" />
                        </div>
                        <div class="col-md-10">
                            <h3 style="color:#2C4064;" >Proprietorship</h3>
                            <p style="color: #69768D;">• Your music. Your IP. You own it. </p>
                            <p style="color: #69768D;">• We protect your IP with our next-gen tech.</p>
                        </div>
                    </div>
                    <div class="row" style="margin-top:3%;margin-left:8%;">
                        <div class="col-md-2">
                        <img class="img-fluid" src="{{url('/assets/img/portfolio/v3.png')}}" id="icon"  style="width: 100%;"  alt="" />
                        </div>
                        <div class="col-md-10">
                            <h3 style="color:#2C4064;" >Profit</h3>
                            <p style="color: #69768D;">• Get paid on your terms when you sell your music. </p>
                            <p style="color: #69768D;">• Get rewarded for your service or contribution to a track.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-7 ">
                        ...
                        <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                            <div class="row">
                                ...
                                <div class="col-md-5" >
                                    ...
                                    <h6 style="color: #2C4064;">Collab With Who You Want</h6>
                                    <p style="color: #69768D;">● Be discovered, discover others.</p>
                                    <p style="color: #69768D;"> <b>● Link up with influencers</b>  and personalities on <b>TikTok, Instagram, or YouTube</b> </p>
                                    <p style="color: #69768D;"> <b>Exchange royalties</b>  with them or pay them directly to include <b>your music in their videos.</b>  </p>
                        ...
                        <div class="row">
                                ...
                                <div class="col-md-5" >
                                    ...
                                    <h6 style="color: #2C4064;">Make What You Want</h6>
                                    <p style="color: #69768D;">Royalty Management System: Removes the risk of depending on others to give you <b>your share of the money. </b> </p>
                        ...
                        <div class="row">
                                ...
                                <div class="col-md-5" >
                                    ...
                                    <h6 style="color: #2C4064;">Get Paid What You Deserve</h6>
                                    <p style="color: #69768D;">Smart Contract System: Allows you to <b>negotiate contracts on your own merit.</b></p>
        ...
        <section style="background: #F0F4F8;">
            <div class="container " style="padding-top:4%;padding-bottom:4%;">
                ...
                <button type="button" class="btn text-white" style="border-radius:25px; width: 150px; height:38px; padding-right:2%; padding-left:2%;background: #24C790;box-shadow: 0px 10px 40px 0px rgba(43, 69, 116, 0.2); font-weight:bold; margin-top:4%;margin-left:8%;
                            "><h6 style="font-weight:bold;">Sign up Free</h6></button>

                            <button type="button" class="btn text-white" style="border-radius:25px; width: 150px; height:38px; padding-right:2%; padding-left:2%;background: #2C4064;box-shadow: 0px 10px 40px 0px rgba(43, 69, 116, 0.2);
        ...
        <section class="page-section portfolio" id="portfolio">
            <div >
                ...
                <div class="col-md-2  mb-5">
                    ...
                    <img src="{{url('/assets/img/portfolio/arrow.png')}}" style="width: 8px;height: 15px;margin-top:5%;" alt="">
                    <div class="col-md-2 mb-5">
        ...
        <section class="page-section bg-primary text-white mb-0" id="about" style="background: linear-gradient(rgba(36,199,144,1), rgba(28,62,123,1));">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-5 ml-auto text-center" style="margin-right: 10%;">
                        ...
                        <h5 class="text-center">The Next-gen Music Streaming
                            ...
                            <button type="button" class="btn bg-light" style="align-items: center;border-radius:25px; width: 150px; height:38px; padding-right:1%; padding-left:1%;background: #2C4064;box-shadow: 0px 10px 40px 0px rgba(43, 69, 116, 0.2);
                            font-weight:bold;margin-top:8%;
                            "><h6 id="t1" style="font-weight:bold;font-weight: 600;
                font-size: 18px;
                line-height: 22px;">Learn more</h6></button>
                    </div>
